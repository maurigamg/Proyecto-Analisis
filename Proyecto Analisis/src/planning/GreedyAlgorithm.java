...
public class GreedyAlgorithm {
  ...
  private void startGreedyAlgorithm() {
    ...
    while (time > 0 && trees.size() != treesUsed.size()) {
      ...
      createTaskOfClosestAvailableTree(trees.get(idTreeClosest),idTreeClosest);
  ...
  private void createTaskOfClosestAvailableTree(TestTree pTree,int pIdTree) {
  ...
  public static void main(String[] args){
    ...
    System.out.println("\nTasks");
    System.out.println(greedyAlgorithm.getTasks().size());
